...
- For *whether UI tools should fire at all*, see the **Category 5: UI emission** rules in the [Tool Usage Framework](./tool-usage-framework.md). Prefer `core.show_card`, `core.show_form`, `core.confirm`, or `core.navigate` over the deprecated `core.emit_ui`.
