...
function staticValidateBicep(bicep) {
    const diagnostics = [];
...
// ── Tool ──────────────────────────────────────────────────────────────────────
export const validateBicepTool = {
    name: 'azure.validate_bicep',
    tool: tool({
        name: 'azure.validate_bicep',
        description: 'Validates a Bicep template for common errors, security anti-patterns, and missing API versions. ' +
...
//# sourceMappingURL=validate-bicep.js.map