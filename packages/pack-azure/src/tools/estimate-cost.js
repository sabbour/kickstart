...
export const estimateCostTool = {
    ...
    tool: tool({
        name: 'azure.estimate_cost',
        description: 'Estimates the monthly Azure cost for a list of resource line items. ' +
        ...
        execute: async (input) => {
            ...
            return {
                ...
                disclaimer: 'Estimates are based on retail list prices and do not reflect reserved instance discounts, ' +
