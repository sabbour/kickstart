...
// ── Tool ──────────────────────────────────────────────────────────────────────
export const armDeployResourceTool = {
    name: 'azure.arm_deploy_resource',
    tool: tool({
        name: 'azure.arm_deploy_resource',
        description: 'Creates or fully replaces a specific Azure resource via ARM PUT. ' +
...
//# sourceMappingURL=arm-deploy-resource.js.map