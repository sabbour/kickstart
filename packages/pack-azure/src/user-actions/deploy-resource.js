...
export const deployResourceUserAction = {
    name: 'azure:deploy-resource',
    wireName: 'azure__deploy_resource',
    description: 'Creates or re-deploys a specific Azure resource via ARM PUT after explicit user confirmation. ' +
...
//# sourceMappingURL=deploy-resource.js.map