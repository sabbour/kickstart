...
export const selectSubscriptionUserAction: UserActionContribution = {
  name: 'azure:select_subscription',
  wireName: 'azure__select_subscription',
  description:
    'Authenticates the user with Azure via MSAL and prompts them to select an active subscription. ' +
