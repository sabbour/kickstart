...
export const updateResourceUserAction: UserActionContribution = {
  name: 'azure:update-resource',
  wireName: 'azure__update_resource',
  description:
    'Partially updates a specific Azure resource via ARM PATCH after explicit user confirmation. ' +
