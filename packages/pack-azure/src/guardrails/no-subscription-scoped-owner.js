...
export const noSubscriptionScopedOwnerGuardrail = {
    ...
    async evaluate(input) {
        ...
        if (!hasOwnerRoleId && !hasOwnerRoleName)
            return { verdict: 'pass' };
        ...
        if (SUBSCRIPTION_SCOPE_PATTERN.test(decoded)) {
            return {
                verdict: 'block',
                reason: `Role assignment blocked: granting Owner at subscription scope "${decoded}" is prohibited. ` +
...
//# sourceMappingURL=no-subscription-scoped-owner.js.map