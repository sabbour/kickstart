...
export function Topbar({ onToggleSidebar, showSessionsToggle }) {
    return (<header className="topbar" role="banner">
      ...
      <div className="topbar-actions">
        {showSessionsToggle && (<button id="topbar-sessions-toggle" className="topbar-btn" aria-label="Toggle sessions" title="Sessions" onClick={onToggleSidebar}>
