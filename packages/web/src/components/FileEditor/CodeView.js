...
export function CodeView({ file }) {
    ...
    if (!file) {
        return (<div className="code-view code-view-empty">
    ...
    return (<div className={`code-view${isGenerating ? ' generating' : ''}`}>
      <div className="code-view-header">
        ...
        <div className="code-view-actions">
          <button className="code-view-btn" onClick={handleCopy} title="Copy to clipboard" type="button">
            {copied ? '✓ Copied' : '📋 Copy'}
          </button>
          <button className="code-view-btn" onClick={handleDownload} title="Download file" type="button">
            ⬇ Download
          </button>
        </div>
      </div>
      <div className="code-view-body">
        <pre className="code-view-pre">
          <code>
            {lines.map((line, i) => (<div key={i} className="code-line">
      ...
      {isGenerating && (<div className="code-view-generating">
