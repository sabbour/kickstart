...
import { Body1, Body2, Caption1, Card, Spinner, Subtitle2, makeStyles, tokens, } from '@fluentui/react-components';
import { CheckmarkCircleRegular, DismissCircleRegular, CircleRegular, } from '@fluentui/react-icons';
    ...
    return (<Card className={classes.root}>
      ...
      <div className={classes.stepList}>
        {steps.map((step, i) => {
            ...
            return (<div key={step.id} className={`${classes.step} ${!isLast ? classes.stepWithConnector : ''}`}>
              ...
              <div className={classes.stepContent}>
                ...
                {step.detail && (<Caption1 className={classes.stepDetail}>{step.detail}</Caption1>)}
                {step.timestamp && (<Caption1 className={classes.stepTimestamp}>{step.timestamp}</Caption1>)}
              </div>
            </div>);
        })}
      </div>
