...
// Safe track-ID pattern — validated upstream by schema; reject anything that
// looks malformed before it reaches the action dispatcher.
      ...
      <div className={classes.grid}>
        {tracks.map((track) => (
          <Card
            ...
            onKeyDown={(e) => {
              if (e.key === 'Enter' || e.key === ' ') handleSelect(track.id, String(track.label));
            }}
