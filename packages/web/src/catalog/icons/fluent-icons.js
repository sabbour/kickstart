...
import { DocumentRegular, FolderRegular, CodeRegular, SettingsRegular, HomeRegular, PersonRegular, SearchRegular, AddRegular, DeleteRegular, EditRegular, SaveRegular, SendRegular, StarRegular, CloudRegular, GlobeRegular, LockClosedRegular, KeyRegular, TagRegular, ChatRegular, ClockRegular, FilterRegular, ArrowLeftRegular, ChevronDownRegular, LinkRegular, CheckmarkCircleRegular, WarningRegular, InfoRegular, DismissRegular, CopyRegular, ArrowUploadRegular, ArrowDownloadRegular, } from '@fluentui/react-icons';
/** Map of icon name → Fluent UI React icon component. */
export const FLUENT_REACT_ICON_REGISTRY = {
    // Documents & files
 ...
 */
export function getFluentIcon(name) {
 ...
 * Returns null if the name is not registered.
 */
export function renderFluentIcon(name, props) {
