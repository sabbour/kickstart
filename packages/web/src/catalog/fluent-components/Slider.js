...
import { Slider as FluentSlider, Label, Body1, makeStyles, tokens, } from '@fluentui/react-components';
...
export const Slider = createReactComponent(SliderApi, ({ props }) => {
    ...
    return (<div className={classes.root}>
      ...
      <FluentSlider min={props.min ?? 0} max={props.max} value={props.value ?? 0} onChange={onChange}/>
    </div>);
});
