...
function surface(surfaceId, components) {
    return [
        { version: 'v0.9', createSurface: { surfaceId, catalogId: CATALOG_ID } },
        { version: 'v0.9', updateComponents: { surfaceId, components } },
    ];
}
export const KICKSTART_SCENARIOS = [
...
const customArchitectureDiagram = () => {
...
// ---------------------------------------------------------------------------
// --- Data Binding ---
const dataBindingBasic = () => {
    const sid = uid('databind-basic');
    return [
        { version: 'v0.9', createSurface: { surfaceId: sid, catalogId: CATALOG_ID } },
        { version: 'v0.9', updateDataModel: { surfaceId: sid, path: '/app/name', value: 'My Web App' } },
        { version: 'v0.9', updateDataModel: { surfaceId: sid, path: '/app/region', value: 'East US 2' } },
...
const dataBindingForm = () => {
    ...
    return [
        { version: 'v0.9', createSurface: { surfaceId: sid, catalogId: CATALOG_ID } },
        { version: 'v0.9', updateDataModel: { surfaceId: sid, path: '/config/appName', value: 'web-api' } },
        { version: 'v0.9', updateDataModel: { surfaceId: sid, path: '/config/replicas', value: 3 } },
        { version: 'v0.9', updateDataModel: { surfaceId: sid, path: '/config/region', value: 'westus2' } },
        { version: 'v0.9', updateComponents: { surfaceId: sid, components: [
 ...
 */
const dataBindingJsonPointerLive = () => {
    ...
    return [
        ...
        { version: 'v0.9', updateDataModel: { surfaceId: sid, path: '/data/name', value: 'my-aks-app' } },
        { version: 'v0.9', updateDataModel: { surfaceId: sid, path: '/data/selectedResource', value: 'aks-cluster-prod' } },
        {
            version: 'v0.9',
            updateComponents: {
                surfaceId: sid,
...
const dataBindingSequence = () => {
    ...
    return [
        ...
        { version: 'v0.9', updateDataModel: { surfaceId: sid, path: '/deployment/status', value: 'Initializing' } },
        { version: 'v0.9', updateDataModel: { surfaceId: sid, path: '/deployment/progress', value: '0%' } },
        { version: 'v0.9', updateDataModel: { surfaceId: sid, path: '/deployment/status', value: 'Building' } },
        { version: 'v0.9', updateDataModel: { surfaceId: sid, path: '/deployment/progress', value: '40%' } },
        { version: 'v0.9', updateDataModel: { surfaceId: sid, path: '/deployment/status', value: 'Deploying' } },
        { version: 'v0.9', updateDataModel: { surfaceId: sid, path: '/deployment/progress', value: '80%' } },
    ];
};
// --- Events & Actions ---
const eventsButtonActions = () => {
    const sid = uid('events-buttons');
    return [
        { version: 'v0.9', createSurface: { surfaceId: sid, catalogId: CATALOG_ID } },
        { version: 'v0.9', updateDataModel: { surfaceId: sid, path: '/app/name', value: 'kickstart-demo' } },
        { version: 'v0.9', updateComponents: { surfaceId: sid, components: [
...
const eventsFormSubmit = () => {
    const sid = uid('events-form');
    return [
        { version: 'v0.9', createSurface: { surfaceId: sid, catalogId: CATALOG_ID } },
        { version: 'v0.9', updateDataModel: { surfaceId: sid, path: '/form/name', value: 'John Doe' } },
        { version: 'v0.9', updateDataModel: { surfaceId: sid, path: '/form/email', value: 'john@example.com' } },
        { version: 'v0.9', updateDataModel: { surfaceId: sid, path: '/form/message', value: 'I need help with AKS deployment' } },
        { version: 'v0.9', updateComponents: { surfaceId: sid, components: [
...
const lifecycleMultiSurface = () => {
    ...
    return [
        ...
        // Surface B - form
        { version: 'v0.9', createSurface: { surfaceId: sidB, catalogId: CATALOG_ID } },
        ...
        // Surface C - status
        { version: 'v0.9', createSurface: { surfaceId: sidC, catalogId: CATALOG_ID } },
...
const lifecycleDeleteSurface = () => {
    ...
    return [
        ...
        // Delete surface A
        { version: 'v0.9', deleteSurface: { surfaceId: sidA } },
    ];
};
// --- Dynamic Patterns ---
const dynamicNestedScopes = () => {
    const sid = uid('dynamic-nested');
    return [
        { version: 'v0.9', createSurface: { surfaceId: sid, catalogId: CATALOG_ID } },
        { version: 'v0.9', updateDataModel: { surfaceId: sid, path: '/services/0', value: { name: 'Web API', status: 'Running', port: 8080 } } },
        { version: 'v0.9', updateDataModel: { surfaceId: sid, path: '/services/1', value: { name: 'Worker', status: 'Stopped', port: 8081 } } },
        { version: 'v0.9', updateComponents: { surfaceId: sid, components: [
...
const dynamicConditionalContent = () => {
    const sid = uid('dynamic-conditional');
    return [
        { version: 'v0.9', createSurface: { surfaceId: sid, catalogId: CATALOG_ID } },
        { version: 'v0.9', updateDataModel: { surfaceId: sid, path: '/feature/enabled', value: true } },
        { version: 'v0.9', updateDataModel: { surfaceId: sid, path: '/feature/name', value: 'Auto-scaling' } },
        { version: 'v0.9', updateComponents: { surfaceId: sid, components: [
...
const dynamicComplexDashboard = () => {
    const sid = uid('dynamic-dashboard');
    return [
        { version: 'v0.9', createSurface: { surfaceId: sid, catalogId: CATALOG_ID } },
        { version: 'v0.9', updateDataModel: { surfaceId: sid, path: '/deployment/name', value: 'production-cluster' } },
        { version: 'v0.9', updateDataModel: { surfaceId: sid, path: '/deployment/status', value: 'Healthy' } },
        { version: 'v0.9', updateDataModel: { surfaceId: sid, path: '/deployment/replicas', value: 5 } },
        { version: 'v0.9', updateDataModel: { surfaceId: sid, path: '/deployment/region', value: 'eastus2' } },
        { version: 'v0.9', updateDataModel: { surfaceId: sid, path: '/deployment/tier', value: 'Standard_D4s_v3' } },
        { version: 'v0.9', updateComponents: { surfaceId: sid, components: [
...
export const ALL_SCENARIOS = [...KICKSTART_SCENARIOS, ...CONTROL_SCENARIOS];
/** Get scenarios grouped by their group name */
export function getGroupedScenarios() {
...
//# sourceMappingURL=playground-scenarios.js.map