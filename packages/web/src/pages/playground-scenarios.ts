...
// ---------------------------------------------------------------------------
// GitHub & Azure Integration Components
// ---------------------------------------------------------------------------

const githubLoginCard = (): A2uiMsg[] => {
  const sid = uid('github-login-demo');
  return surface(sid, [
    { id: 'root', component: 'Column', children: ['heading', 'desc', 'login-card'], gap: 'medium' },
    { id: 'heading', component: 'Text', text: 'GitHub Login Card', variant: 'h3' },
    { id: 'desc', component: 'Text', text: 'Self-managing GitHub authentication with OAuth Device Flow. Shows sign-in button or user profile when authenticated.', variant: 'body2' },
    { id: 'login-card', component: 'GitHubLoginCard',
      username: 'octocat',
      avatarUrl: 'https://avatars.githubusercontent.com/u/583231?v=4',
      onSignIn: { event: { name: 'github-sign-in' } },
      onSignOut: { event: { name: 'github-sign-out' } },
    },
  ] as A2uiComponent[]);
};

const githubRepoPicker = (): A2uiMsg[] => {
  const sid = uid('github-repo-demo');
  return surface(sid, [
    { id: 'root', component: 'Column', children: ['heading', 'desc', 'picker'], gap: 'medium' },
    { id: 'heading', component: 'Text', text: 'GitHub Repo Picker', variant: 'h3' },
    { id: 'desc', component: 'Text', text: 'Searchable dropdown for selecting GitHub repositories. Supports pagination and auto-complete.', variant: 'body2' },
    { id: 'picker', component: 'GitHubRepoPicker',
      placeholder: 'Search repositories…',
      selectedRepo: 'sabbour/aks-store-demo',
      onSelect: { event: { name: 'repo-selected', context: { repo: { path: '/github/selectedRepo' } } } },
    },
  ] as A2uiComponent[]);
};

const githubAction = (): A2uiMsg[] => {
  const sid = uid('github-action-demo');
  return surface(sid, [
    { id: 'root', component: 'Column', children: ['heading', 'desc', 'action-card'], gap: 'medium' },
    { id: 'heading', component: 'Text', text: 'GitHub Action', variant: 'h3' },
    { id: 'desc', component: 'Text', text: 'Execute GitHub API operations with confirmation dialogs. Supports POST, PUT, PATCH, DELETE with protected branch validation.', variant: 'body2' },
    { id: 'action-card', component: 'GitHubAction',
      title: 'Enable GitHub Actions',
      description: 'This will enable the CI/CD workflow for the selected repository.',
      method: 'PUT',
      path: '/repos/sabbour/aks-store-demo/actions/permissions',
      operationType: 'enable-actions',
      body: { enabled: true, allowed_actions: 'all' },
      confirmLabel: 'Enable Actions',
      onSuccess: { event: { name: 'github-action-success' } },
      onError: { event: { name: 'github-action-error' } },
    },
  ] as A2uiComponent[]);
};

const githubCommit = (): A2uiMsg[] => {
  const sid = uid('github-commit-demo');
  return surface(sid, [
    { id: 'root', component: 'Column', children: ['heading', 'desc', 'commit-card'], gap: 'medium' },
    { id: 'heading', component: 'Text', text: 'GitHub Commit & PR', variant: 'h3' },
    { id: 'desc', component: 'Text', text: 'Multi-step workflow: select files → configure branch → create PR. Integrates with the artifact context for generated files.', variant: 'body2' },
    { id: 'commit-card', component: 'GitHubCommit',
      repoFullName: 'sabbour/aks-store-demo',
      defaultBranch: 'main',
      suggestedBranchName: 'kickstart/add-aks-manifests',
      suggestedTitle: 'Add AKS deployment manifests',
      suggestedBody: 'Generated by Kickstart:\n- Kubernetes Deployment\n- Service\n- Ingress\n- HPA configuration',
      onSuccess: { event: { name: 'commit-success' } },
      onError: { event: { name: 'commit-error' } },
    },
  ] as A2uiComponent[]);
};

const azureLoginCard = (): A2uiMsg[] => {
  const sid = uid('azure-login-demo');
  return surface(sid, [
    { id: 'root', component: 'Column', children: ['heading', 'desc', 'login-card'], gap: 'medium' },
    { id: 'heading', component: 'Text', text: 'Azure Login Card', variant: 'h3' },
    { id: 'desc', component: 'Text', text: 'MSAL-based Azure authentication. Shows subscription list when authenticated with token info display.', variant: 'body2' },
    { id: 'login-card', component: 'AzureLoginCard',
      displayName: 'Ahmed Sabbour',
      showTokenInfo: false,
      onSignIn: { event: { name: 'azure-sign-in' } },
      onSignOut: { event: { name: 'azure-sign-out' } },
    },
  ] as A2uiComponent[]);
};

const azureResourcePicker = (): A2uiMsg[] => {
  const sid = uid('azure-picker-demo');
  return surface(sid, [
    { id: 'root', component: 'Column', children: ['heading', 'desc', 'picker'], gap: 'medium' },
    { id: 'heading', component: 'Text', text: 'Azure Resource Picker', variant: 'h3' },
    { id: 'desc', component: 'Text', text: 'Cascading subscription → resource group → resource selector with search filtering. Auto-selects when single option.', variant: 'body2' },
    { id: 'picker', component: 'AzureResourcePicker',
      label: 'Select AKS Cluster',
      resourceType: 'Microsoft.ContainerService/managedClusters',
      onSelect: { event: { name: 'resource-selected', context: { resourceId: { path: '/azure/selectedResource' } } } },
    },
  ] as A2uiComponent[]);
};

const azureResourceForm = (): A2uiMsg[] => {
  const sid = uid('azure-form-demo');
  return surface(sid, [
    { id: 'root', component: 'Column', children: ['heading', 'desc', 'form'], gap: 'medium' },
    { id: 'heading', component: 'Text', text: 'Azure Resource Form', variant: 'h3' },
    { id: 'desc', component: 'Text', text: 'Dynamic form generated from ARM resource type metadata. Validates subscription IDs and resource group names.', variant: 'body2' },
    { id: 'form', component: 'AzureResourceForm',
...
const azureAction = (): A2uiMsg[] => {
  const sid = uid('azure-action-demo');
  return surface(sid, [
    { id: 'root', component: 'Column', children: ['heading', 'desc', 'action-card'], gap: 'medium' },
    { id: 'heading', component: 'Text', text: 'Azure Action', variant: 'h3' },
    { id: 'desc', component: 'Text', text: 'Execute ARM API operations with confirmation. Validates paths, allowlists resource types, and requires typed confirmation for DELETE.', variant: 'body2' },
    { id: 'action-card', component: 'AzureAction',
      title: 'Scale AKS Node Pool',
      description: 'Update the system node pool to 5 nodes for production workloads.',
      method: 'PATCH',
      path: '/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/rg-kickstart/providers/Microsoft.ContainerService/managedClusters/aks-prod/agentPools/system',
      apiVersion: '2024-09-01',
      body: { properties: { count: 5 } },
      confirmLabel: 'Scale Nodes',
      onSuccess: { event: { name: 'azure-action-success' } },
      onError: { event: { name: 'azure-action-error' } },
    },
  ] as A2uiComponent[]);
};
...
const deploymentProgress = (): A2uiMsg[] => {
  const sid = uid('deploy-progress-demo');
  return surface(sid, [
    { id: 'root', component: 'Column', children: ['heading', 'desc', 'progress'], gap: 'medium' },
    { id: 'heading', component: 'Text', text: 'Deployment Progress', variant: 'h3' },
    { id: 'desc', component: 'Text', text: 'Multi-step deployment tracker with status indicators, timestamps, and detail text per phase.', variant: 'body2' },
    { id: 'progress', component: 'DeploymentProgress',
      title: 'Deploying to AKS',
      overallStatus: 'running',
      steps: [
        { id: 'build', label: 'Build Container Image', status: 'complete', detail: 'Image pushed to ACR', timestamp: '14:23:45' },
        { id: 'infra', label: 'Provision Infrastructure', status: 'complete', detail: 'AKS cluster ready', timestamp: '14:25:12' },
        { id: 'deploy', label: 'Deploy Application', status: 'running', detail: 'Rolling out pods…', timestamp: '14:26:30' },
        { id: 'verify', label: 'Health Check', status: 'pending' },
        { id: 'dns', label: 'Configure DNS', status: 'pending' },
      ],
    },
  ] as A2uiComponent[]);
};

const costEstimate = (): A2uiMsg[] => {
  const sid = uid('cost-estimate-demo');
  return surface(sid, [
    { id: 'root', component: 'Column', children: ['heading', 'desc', 'cost'], gap: 'medium' },
    { id: 'heading', component: 'Text', text: 'Cost Estimate', variant: 'h3' },
    { id: 'desc', component: 'Text', text: 'Interactive cost breakdown with SKU selection, projection slider, and currency formatting.', variant: 'body2' },
    { id: 'cost', component: 'CostEstimate',
      ...
      projectionMonths: 12,
      resources: [
        { name: 'AKS Cluster', sku: 'Standard_D4s_v3', monthlyEstimate: 280.32,
          skuOptions: [
            { label: 'Standard_D2s_v3', value: 'D2s_v3', monthlyEstimate: 140.16 },
            { label: 'Standard_D4s_v3', value: 'D4s_v3', monthlyEstimate: 280.32 },
            { label: 'Standard_D8s_v3', value: 'D8s_v3', monthlyEstimate: 560.64 },
          ] },
        { name: 'Container Registry', sku: 'Basic', monthlyEstimate: 5.00,
          skuOptions: [
            { label: 'Basic', value: 'Basic', monthlyEstimate: 5.00 },
            { label: 'Standard', value: 'Standard', monthlyEstimate: 20.00 },
            { label: 'Premium', value: 'Premium', monthlyEstimate: 50.00 },
          ] },
        { name: 'Key Vault', sku: 'Standard', monthlyEstimate: 0.03 },
        { name: 'Log Analytics', sku: 'Per-GB', monthlyEstimate: 7.50 },
      ],
      total: 292.85,
    },
  ] as A2uiComponent[]);
...
const fileEditor = (): A2uiMsg[] => {
  const sid = uid('file-editor-demo');
  return surface(sid, [
    { id: 'root', component: 'Column', children: ['heading', 'desc', 'editor'], gap: 'medium' },
    { id: 'heading', component: 'Text', text: 'File Editor', variant: 'h3' },
    { id: 'desc', component: 'Text', text: 'Tabbed file viewer with syntax highlighting. Supports single-file and multi-file modes with language auto-detection.', variant: 'body2' },
    { id: 'editor', component: 'FileEditor',
      readOnly: true,
      files: [
        { fileName: 'deployment.yaml', language: 'yaml', content: `apiVersion: apps/v1
kind: Deployment
metadata:
  name: web-app
  labels:
    ...
    spec:
      containers:
        - name: web
          ...
          ports:
            - containerPort: 8080` },
        { fileName: 'service.yaml', language: 'yaml', content: `apiVersion: v1
kind: Service
metadata:
  name: web-app-svc
spec:
...
export const CONTROL_SCENARIOS: ScenarioDef[] = [
  ...
  // GitHub Integration
  { id: 'ctrl-github-login',  label: 'GitHubLoginCard',  description: 'OAuth Device Flow authentication',           group: 'GitHub Integration', catalog: 'kickstart', generate: githubLoginCard },
  { id: 'ctrl-github-repo',   label: 'GitHubRepoPicker',  description: 'Searchable repo selector with pagination',    group: 'GitHub Integration', catalog: 'kickstart', generate: githubRepoPicker },
  { id: 'ctrl-github-action', label: 'GitHubAction',      description: 'API operations with confirmation dialog',     group: 'GitHub Integration', catalog: 'kickstart', generate: githubAction },
  { id: 'ctrl-github-commit', label: 'GitHubCommit',      description: 'Branch + commit + PR creation workflow',      group: 'GitHub Integration', catalog: 'kickstart', generate: githubCommit },
  // Azure Integration
  { id: 'ctrl-azure-login',   label: 'AzureLoginCard',    description: 'MSAL authentication with subscriptions',      group: 'Azure Integration', catalog: 'kickstart', generate: azureLoginCard },
  { id: 'ctrl-azure-picker',  label: 'AzureResourcePicker', description: 'Cascading subscription/RG/resource selector', group: 'Azure Integration', catalog: 'kickstart', generate: azureResourcePicker },
  { id: 'ctrl-azure-form',    label: 'AzureResourceForm', description: 'Dynamic ARM resource creation form',          group: 'Azure Integration', catalog: 'kickstart', generate: azureResourceForm },
  { id: 'ctrl-azure-action',  label: 'AzureAction',       description: 'ARM API operations with confirmation',        group: 'Azure Integration', catalog: 'kickstart', generate: azureAction },
  // Deployment & Output
  { id: 'ctrl-deploy-progress', label: 'DeploymentProgress', description: 'Multi-phase deployment status tracker',    group: 'Deployment & Output', catalog: 'kickstart', generate: deploymentProgress },
  { id: 'ctrl-cost-estimate',   label: 'CostEstimate',      description: 'Resource cost breakdown with SKU options',  group: 'Deployment & Output', catalog: 'kickstart', generate: costEstimate },
  { id: 'ctrl-file-editor',     label: 'FileEditor',        description: 'Tabbed syntax-highlighted file viewer',     group: 'Deployment & Output', catalog: 'kickstart', generate: fileEditor },
  // Data Binding
