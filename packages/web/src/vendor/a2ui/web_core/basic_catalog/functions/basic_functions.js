 ...
 */
import { ExpressionParser } from '../expressions/expression_parser';
import { computed } from '@preact/signals-core';
import { createFunctionImplementation, FunctionImplementation, isSignal, } from '../../catalog/types';
import { format } from 'date-fns';
import { AddApi, SubtractApi, MultiplyApi, DivideApi, EqualsApi, NotEqualsApi, GreaterThanApi, LessThanApi, AndApi, OrApi, NotApi, ContainsApi, StartsWithApi, EndsWithApi, RequiredApi, RegexApi, LengthApi, NumericApi, EmailApi, FormatStringApi, FormatNumberApi, FormatCurrencyApi, FormatDateApi, PluralizeApi, OpenUrlApi, } from './basic_functions_api';
import { A2uiExpressionError } from '../../errors';
// Arithmetic
/**
