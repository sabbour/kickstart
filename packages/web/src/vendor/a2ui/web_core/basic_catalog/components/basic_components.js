 ...
 */
import { z } from 'zod';
import { DynamicStringSchema, DynamicNumberSchema, DynamicBooleanSchema, DynamicStringListSchema, ChildListSchema, ComponentIdSchema, ActionSchema, AccessibilityAttributesSchema, CheckableSchema, } from '../../schema/common-types';
...
export const TableApi = {
    ...
    schema: z
        ...
        rows: z
            ...
            .describe('The table rows. Each row is an array of cell values matching the columns order.'),
        caption: DynamicStringSchema.describe('An optional caption displayed above the table.').optional(),
    })
        .strict()
        .describe('A data table for displaying structured tabular data such as comparisons, resource listings, or configuration details.'),
};
export const AlertApi = {
    ...
    schema: z
        ...
        .strict()
        .describe('A severity-colored banner for communicating status, feedback, or important information to the user.'),
};
export const LinkApi = {
    ...
    schema: z
        ...
        external: z
            .boolean()
            .default(false)
            .describe('If true, the link opens in a new tab with noopener/noreferrer.')
            .optional(),
    })
        .strict()
        .describe('A hyperlink component for navigating to external URLs such as documentation, Codespaces, or dashboards.'),
};
