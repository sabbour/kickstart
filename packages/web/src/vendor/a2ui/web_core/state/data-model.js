 ...
 */
import { Subscription as BaseSubscription } from '../common/events';
import { A2uiDataError } from '../errors';
...
export class DataModel {
    data = {};
    signals = new Map();
    subscriptions = new Set(); // To track direct subscriptions for dispose
    /**
