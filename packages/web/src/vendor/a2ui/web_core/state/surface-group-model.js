...
import { EventEmitter, EventSource, Subscription } from '../common/events';
import { A2uiClientAction } from '../schema/client-to-server';
/**
...
export class SurfaceGroupModel {
    surfaces = new Map();
    surfaceUnsubscribers = new Map();
    _onSurfaceCreated = new EventEmitter();
    _onSurfaceDeleted = new EventEmitter();
    _onAction = new EventEmitter();
    /** Fires when a new surface is added. */
    onSurfaceCreated = this._onSurfaceCreated;
    /** Fires when a surface is removed. */
    onSurfaceDeleted = this._onSurfaceDeleted;
