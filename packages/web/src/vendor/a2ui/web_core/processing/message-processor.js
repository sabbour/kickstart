...
import { ComponentModel } from '../state/component-model';
import { Subscription } from '../common/events';
import { zodToJsonSchema } from 'zod-to-json-schema';
import { A2uiMessage, CreateSurfaceMessage, UpdateComponentsMessage, UpdateDataModelMessage, DeleteSurfaceMessage, } from '../schema/server-to-client';
import { A2uiClientCapabilities, InlineCatalog, } from '../schema/client-capabilities';
import { A2uiClientDataModel } from '../schema/client-to-server';
import { A2uiStateError, A2uiValidationError } from '../errors';
/**
...
export class MessageProcessor {
    ...
    generateInlineCatalog(catalog) {
        ...
        for (const [name, api] of catalog.components.entries()) {
            // @ts-ignore — deep Zod type instantiation (vendored code)
