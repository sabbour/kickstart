...
import { ComponentContext } from '../web_core/index';
...
export const DeferredChild = memo(({ surface, id, basePath }) => {
    ...
    return (<ResolvedChild surface={surface} id={id} basePath={basePath} componentModel={componentModel} compImpl={compImpl}/>);
});
...
//# sourceMappingURL=A2uiSurface.js.map