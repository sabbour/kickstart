...
const FALLBACK_IDEAS = [
    {
        ...
        prompt: "I want to build a movie night pick app that settles disputes — your group votes, and the app chooses confidently.",
    },
    {
        title: "AI recipe finder from fridge photos",
        subtitle: "Snap a photo of your fridge, get dinner ideas instantly.",
        prompt: "I want to build an AI recipe finder from fridge photos — snap a photo of your fridge, get dinner ideas instantly.",
    },
    {
        title: "Team standup bot that respects time zones",
        subtitle: "Async standups that actually work for global teams.",
        prompt: "I want to build a team standup bot that respects time zones — async standups that actually work for global teams.",
    },
    {
        title: "Pet adoption matcher powered by AI",
        subtitle: "Swipe-style matching between shelters and families.",
        prompt: "I want to build a pet adoption matcher powered by AI — swipe-style matching between shelters and families.",
    },
    {
        title: "Real-time air quality dashboard",
        subtitle: "Hyperlocal pollution data with health recommendations.",
        prompt: "I want to build a real-time air quality dashboard — hyperlocal pollution data with health recommendations.",
    },
    {
        title: "Neighborhood tool lending library",
        subtitle: "Borrow a drill from your neighbor — no awkward texts required.",
        prompt: "I want to build a neighborhood tool lending library — borrow a drill from your neighbor, no awkward texts required.",
    },
    {
        title: "Personal finance coach that speaks plain English",
        subtitle: "Budget tracking without the spreadsheet headaches.",
        prompt: "I want to build a personal finance coach that speaks plain English — budget tracking without the spreadsheet headaches.",
    },
    {
        title: "Workout generator for hotel rooms",
        subtitle: "No equipment? No problem. AI builds a routine in seconds.",
        prompt: "I want to build a workout generator for hotel rooms — no equipment needed, AI builds a routine in seconds.",
    },
    {
        title: "Live event parking optimizer",
        subtitle: "Find the fastest lot and walking route to the venue.",
        prompt: "I want to build a live event parking optimizer — find the fastest lot and walking route to the venue.",
    },
    {
        title: "Study group matchmaker for college",
        subtitle: "Match with classmates by course, schedule, and study style.",
        prompt: "I want to build a study group matchmaker for college — match with classmates by course, schedule, and study style.",
    },
];
// ---------------------------------------------------------------------------
// Helpers
...
function randomDomainHint() {
    return INSPIRATION_DOMAINS[Math.floor(Math.random() * INSPIRATION_DOMAINS.length)];
}
