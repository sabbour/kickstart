...
### Input Components
- Button: {"id":"btn1","component":"Button","label":"Select Node.js","variant":"primary","action":{"event":{"name":"select","data":{"value":"node"}}}}
