...
const PRIVATE_IP_RE = /^(127\.|10\.|172\.(1[6-9]|2\d|3[01])\.|192\.168\.|::1$|0\.0\.0\.0$|169\.254\.)/;
...
export const fetchWebpageTool = {
    ...
    tool: tool({
        name: 'core.fetch_webpage',
        description: 'Fetches an HTTPS URL and returns the page body as plain text (markdown where possible). ' +
...
//# sourceMappingURL=fetch_webpage.js.map