...
import { resolveA2UICapability, createA2UIResource, createA2UIDocument, degradeToBasic, A2UI_MIME_TYPE, KICKSTART_CATALOG_ID, } from "../a2ui.js";
...
describe("degradeToBasic", () => {
    ...
    it("uses the provided title when given", () => {
        ...
        const result = degradeToBasic(custom, "My Title");
...
//# sourceMappingURL=a2ui.test.js.map