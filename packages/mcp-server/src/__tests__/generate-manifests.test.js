...
function createCompleteSession(sessionId, overrides) {
...
describe("handleGenerateManifests", () => {
    ...
    it("manifest resource URI follows the expected pattern", async () => {
        ...
        const uri = manifestRes.resource.uri;
    ...
    it("non-production tier passes production-only safeguards automatically", async () => {
        ...
        const cardDoc = JSON.parse(safeguardResource.resource.text);
...
//# sourceMappingURL=generate-manifests.test.js.map