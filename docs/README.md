...
- [Packs & skills](../docs-site/docs/guides/packs-and-skills.md)
- [Observability](../docs-site/docs/operations/observability.md)
...
> The `fsm.md` and `v2-implementation-brief.md` internal docs were retired when the harness + packs architecture shipped as the product baseline (see `CHANGELOG.md` v1.0.2, 2026-04-20). There is no successor page; architecture guidance now lives at [`architecture/overview.md`](../docs-site/docs/architecture/overview.md).
